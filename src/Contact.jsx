...
const Contact = () => {
    ...
    const formSubmit = (e) => {
        e.preventDefault();
        alert(
            `Name: ${data.fullname}. Mobile: ${data.phone}. Email: ${data.email}. Message: ${data.massage}`
        );
    };
                ...
                <div className="col-md-6 col-10 mx-auto">
                    <form onSubmit={formSubmit}>
                        ...
                        <div className="mb-3">
                            ...
                            <textarea className="form-control" rows="3" name="massage" value={data.massage} onChange={InputEvent} ></textarea>
                        </div>
